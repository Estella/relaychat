...
| 1.2+ | TRUST/DETRUST | #[channel] [user] | Grant or revoke trusted privileges to a user for a channel. Trust users can set channel topics. | `[message id] [user] (DE)TRUST #[channel] [other user]` |
